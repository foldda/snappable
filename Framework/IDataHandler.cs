...
{
    /// <summary>
    /// IDataHandler represents the abstraction of a unit of independent process which can be one these three types. 
    /// 
    ...
    /// 
    /// Via its IDataHandlerManager, IDataHandler interacts with its outside environment by -
    /// 
    ...
    public interface IDataHandler
    {
        ...
        IHandlerManager HandlerManager { get; }    //set by constructor
