...
namespace Foldda.Automation.Framework
{
    ...
    /// 
    /// </summary>
    public interface IHandlerMessageBoard
    {
        /*
        ...
        void PostMessage(IHandlerManager sender, string receiverId, IRda message, DateTime expiryTime);
        ...
        /// <returns></returns>
        List<IRda> CollectMessage(IHandlerManager receiver);
    }
